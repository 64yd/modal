...
UUID = os.environ.get('UUID', '3f80c068-5f74-4456-8b59-5f297f7be6d0')       
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.97553557.cf')              
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')                         
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'tcJMXPsaLRCKAUrV9s')                             
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'modele.12345kkk.net')                            
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNGVjYjA4MWQzNDA5OTFkNWJiN2MyMTI0MmU0OGNjN2UiLCJ0IjoiN2VmNzRhNjctNmMyNi00MzMzLWI5ZDktNDQ4ODkyODk2MTE4IiwicyI6Ik1UazJNbUkxTUdZdE9UZ3hOUzAwWldWaUxXSXhNR0V0TkdGa01HRmpaakU1TW1JeCJ9') 
